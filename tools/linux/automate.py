...
def install_qt():
  ...
  if not base.is_file("./qt_source_5.9.9.tar.xz"):
    ...
    #base.download("https://ftp.fau.de/qtproject/archive/qt/5.9/5.9.9/single/qt-everywhere-opensource-src-5.9.9.tar.xz", "./qt_source_5.9.9.tar.xz")
    base.download("http://ansible.agat.local/repo/server/qt/qt-everywhere-opensource-src-5.9.9.tar.xz", "./qt_source_5.9.9.tar.xz")
